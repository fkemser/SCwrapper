...
#  arg_p11_module
#-------------------------------------------------------------------------------
readonly L_SC_EN_HLP_DES_ARG_P11_MODULE="Specify the PKCS#11 module/library to use. This parameter is automatically set. However, for special use cases, you can manually change it."
